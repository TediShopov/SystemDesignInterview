...
float4 main(InputType input) : SV_TARGET
{
    ...
    colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texPower * -4.0f)) * weight4;
    colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texPower * -3.0f)) * weight3;

    colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texPower * -2.0f)) * weight2;
    colour += shaderTexture.Sample(SampleType, input.tex + float2(0.0f, texPower * -1.0f)) * weight1;
